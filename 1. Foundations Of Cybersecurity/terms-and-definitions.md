# Terms and Definitions: Course 1
...
- **CIA triad:** Confidentiality, integrity, and availability model used to guide security risk decisions.
...
- **NIST Cybersecurity Framework:** Voluntary framework with standards, guidelines, and best practices.
- **Network protocol analyzer:** Tool capturing and analyzing data traffic within a network.
...
- **PII:** Information used to infer an individual's identity.
...
- **Programming:** Process used to create instructions for a computer to execute tasks.
- **PHI:** Information related to the past, present, or future physical or mental health of an individual.
...
- **SIEM:** Application collecting and analyzing log data to monitor critical activities.
- **Security posture:** Organization's ability to manage defense of critical assets and data and react to change.
- **SPII:** Specific type of PII falling under stricter handling guidelines.
- **Social engineering:** Manipulation technique exploiting human error to gain private information, access, or valuables.
- **Spear phishing:** Malicious email attack targeting a specific user or group and appearing to originate from a trusted source.
- **SQL:** Programming language used to create, interact with, and request information from a database.
- **Supply-chain attack:** Attack targeting systems, applications, hardware, or software to locate vulnerabilities for deploying malware.
...
- **USB baiting:** Attack where a threat actor leaves a malware USB device for an employee to find and install.

## V

- **Virus:** Malicious code that interferes with computer operations and may cause damage.
- **Vishing:** Exploitation of voice communication to obtain sensitive information or impersonate a known source.
